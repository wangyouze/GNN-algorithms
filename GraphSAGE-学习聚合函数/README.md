...
* 加载数据集，我们使用[tf_geometric](https://github.com/CrawlScript/tf_geometric)自带的PPI数据集。 tf_geometric提供了非常简单的图数据构建接口，只需要传入简单的Python数组或Numpy数组作为节点特征和邻接表就可以构建自己的数据集，如[GIN](https://github.com/wangyouze/GNN-algorithms/tree/master/GIN-%E5%9B%BE%E5%90%8C%E6%9E%84%E7%BD%91%E7%BB%9C)。
